  ...
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        amount: 100,
        reason: 'TOURNAMENT_WIN',
        gradient: 'from-amber-700/30 to-amber-950/50 border-amber-600/40 text-amber-400',
        badgeColor: 'bg-amber-500/20 text-amber-300 border-amber-500/30',
      },
      {
        id: 'one-buyin-bonus',
        title: '원바인 우승 추가',
        subtitle: '1-Buyin Win Extra Bonus',
        amount: 100,
        reason: 'TOURNAMENT_WIN',
        gradient: 'from-yellow-600/30 to-yellow-950/50 border-yellow-500/40 text-yellow-300',
    ...
    actions: [
      {
        id: 'new-member',
        title: '신규가입 웰컴',
        subtitle: 'New Member Welcome',
        amount: 500,
        reason: 'EVENT_BONUS',
        gradient: 'from-indigo-600/30 to-indigo-950/50 border-indigo-500/40 text-indigo-300',
      ...
      },
      {
        ...
        amount: 300,
        reason: 'EVENT_BONUS',
        gradient: 'from-teal-600/30 to-teal-950/50 border-teal-500/40 text-teal-300',
      ...
      },
      {
        ...
        amount: 1000,
        reason: 'EVENT_BONUS',
        gradient: 'from-cyan-600/30 to-cyan-950/50 border-cyan-500/40 text-cyan-300',
    ...
    actions: [
      {
        id: 'seed-ticket',
        title: '대회 시드권 교환',
        subtitle: 'Seed Ticket Exchange',
        amount: -5000,
        reason: 'POINT_SHOP_USAGE',
        gradient: 'from-rose-700/30 to-rose-950/50 border-rose-600/40 text-rose-300',
        badgeColor: 'bg-rose-500/20 text-rose-300 border-rose-500/30',
      },
      {
        id: 'rebuyin',
        title: '리바인 (Re-Buyin)',
        subtitle: 'Re-Buyin Entry',
        amount: -5000,
        reason: 'TOURNAMENT_BUYIN',
        gradient: 'from-red-800/30 to-red-950/50 border-red-600/40 text-red-300',
